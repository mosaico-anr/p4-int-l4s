...
ax1.plot( x, get(data_int_yes, 0),    linewidth=1, color = 'b', label="CPU - with INT" )
ax1.plot( x, get(data_int_false, 0) , linewidth=1, color = 'r', label="CPU - without INT" )
ax1.set_ylabel("CPU usage (%)")


ax2=ax1.twinx()
ax2.plot( x, get(data_int_yes, 1),    linewidth=1, color = 'peru',    label="Memory - with INT" )
ax2.plot( x, get(data_int_false, 1) , linewidth=1, color = '#5C2A9D', label="Memory - without INT" )
